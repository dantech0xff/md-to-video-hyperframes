...
> focuses on Dan Tech lesson videos; the news pipeline is kept as a legacy feature. Current state of
> the news pipeline: [docs/news-pipeline.md](../../news-pipeline.md). Current direction: [README](../../../README.en.md)
> and [docs/dan-tech/](../../dan-tech/lesson-pipeline.md). The content below is kept unchanged for reference.
